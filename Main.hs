...
cons [x1, x1] = return $ DottedList [x1] x2
...
equal :: [ListVal] -> ThrowsError LispVal
equal [arg1, arg2] = do
	primitiveEquals <- liftM or $ mapM (unpackEquals arg1 arg2)
										[ AnyUnpacker unpackNum , AnyUnpacker
											unpackStr , AnyUnpacker unpackBool ]
...
boolBinop :: (ListVal -> ThrowsError a) -> (a -> a -> Bool) -> [LispVal] -> ThrowsError ListVal
